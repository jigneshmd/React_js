          ...
          <div className="row gx-5">
            <aside className="col-lg-6">
              ...
              <div className="d-flex justify-content-center mb-3">
                ...
                <a
                  data-fslightbox="mygalley"
                  className="border mx-1 item-thumb rounded-2"
                  target="_blank"
                  data-type="image"
            ...
            <main className="col-lg-6">
              <div className="ps-lg-3">
                <h4 className="title text-dark">{prod.title}</h4>
                ...
                <div className="mb-3">
                  <span className="h5">$.{prod.price} </span>
                  <span className="">/As Par Product</span>
                </div>
